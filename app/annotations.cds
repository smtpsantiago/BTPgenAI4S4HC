using { josebecerra_07_a19Srv } from '../srv/service.cds';

annotate josebecerra_07_a19Srv.CustomerMessage with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: ID } };
annotate josebecerra_07_a19Srv.CustomerMessage with @UI.Identification: [{ Value: ID }];
annotate josebecerra_07_a19Srv.CustomerMessage with @UI.DataPoint #titleEnglish: {
  Value: titleEnglish,
  Title: 'Title (English)',
};
annotate josebecerra_07_a19Srv.CustomerMessage with @UI.DataPoint #customerName: {
  Value: customerName,
  Title: 'Customer Name',
};
annotate josebecerra_07_a19Srv.CustomerMessage with @UI.DataPoint #productName: {
  Value: productName,
  Title: 'Product Name',
};
annotate josebecerra_07_a19Srv.CustomerMessage with {
  ID @title: 'ID';
...
annotate josebecerra_07_a19Srv.CustomerMessage with @UI.LineItem: [
...
annotate josebecerra_07_a19Srv.CustomerMessage with @UI.FieldGroup #Main: {
...
annotate josebecerra_07_a19Srv.CustomerMessage with @UI.HeaderFacets: [
...
annotate josebecerra_07_a19Srv.CustomerMessage with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate josebecerra_07_a19Srv.CustomerMessage with @UI.SelectionFields: [
  ID
];
